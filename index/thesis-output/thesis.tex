...
\end{verbatim}
\begin{center}\includegraphics{thesis_files/figure-latex/ICgraphs-1} \end{center}
\begin{center}\includegraphics{thesis_files/figure-latex/ICgraphs-2} \end{center}
\begin{center}\includegraphics{thesis_files/figure-latex/ICgraphs-3} \end{center}
\begin{center}\includegraphics{thesis_files/figure-latex/ICgraphs-4} \end{center}
\begin{center}\includegraphics{thesis_files/figure-latex/ICgraphs-5} \end{center}
\begin{verbatim}
...
[[1]]
\end{verbatim}
\begin{center}\includegraphics{thesis_files/figure-latex/ICinc-1} \end{center}
\begin{verbatim}
[[2]]
\end{verbatim}
\begin{center}\includegraphics{thesis_files/figure-latex/ICinc-2} \end{center}
\begin{verbatim}
[[3]]
\end{verbatim}
\begin{center}\includegraphics{thesis_files/figure-latex/ICinc-3} \end{center}
\begin{verbatim}
[[4]]
\end{verbatim}
\begin{center}\includegraphics{thesis_files/figure-latex/ICinc-4} \end{center}
\begin{verbatim}
[[5]]
\end{verbatim}
\begin{center}\includegraphics{thesis_files/figure-latex/ICinc-5} \end{center}
\begin{verbatim}
[[6]]
\end{verbatim}
\begin{center}\includegraphics{thesis_files/figure-latex/ICinc-6} \end{center}
\begin{verbatim}
[[7]]
\end{verbatim}
\begin{center}\includegraphics{thesis_files/figure-latex/ICinc-7} \end{center}
\begin{verbatim}
[[8]]
\end{verbatim}
\begin{verbatim}
...
\end{verbatim}
\begin{center}\includegraphics{thesis_files/figure-latex/ICinc-8} \end{center}
\begin{verbatim}
[[9]]
\end{verbatim}
\begin{verbatim}
...
Warning: Removed 1 row(s) containing missing values (geom_path).
\end{verbatim}
\begin{center}\includegraphics{thesis_files/figure-latex/ICinc-9} \end{center}
\begin{verbatim}
[[10]]
\end{verbatim}
\begin{verbatim}
...
Warning: Removed 1 row(s) containing missing values (geom_path).
\end{verbatim}
\begin{center}\includegraphics{thesis_files/figure-latex/ICinc-10} \end{center}
\begin{verbatim}
[[11]]
\end{verbatim}
\begin{verbatim}
...
Warning: Removed 1 row(s) containing missing values (geom_path).
\end{verbatim}
\begin{center}\includegraphics{thesis_files/figure-latex/ICinc-11} \end{center}
\begin{verbatim}
[[12]]
\end{verbatim}
\begin{verbatim}
...
Warning: Removed 1 row(s) containing missing values (geom_path).
\end{verbatim}
\begin{center}\includegraphics{thesis_files/figure-latex/ICinc-12} \end{center}
\begin{itemize}
\item
...
{\centering \includegraphics[width=0.5\linewidth]{C:/Users/harmv/Documents/studie/scriptie/Master/Master_Thesis/index/figures/graph} 
