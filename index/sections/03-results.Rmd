...
ICplotdata  <- IC_raw_data %>% 
  ...
  group_by(sample) %>% 
  mutate(P = (mean(Phosphate)*1000)/94.9714, S = mean(Sulphate)*1000/96.06, Br = mean(Bromide)*1000/79.9, Fl = mean(Fluoride)*1000/19, Cl = mean(Chloride)*1000/35.45 ) %>%
...
# reshape data.
molten_IC_core_data <- ICplotdata %>% select("location", "sample", "cm_below_swi", "P" : "treated") %>% 
