...
IC_incubation_graph <- 
  ...
  facet_grid(variable ~ oxic_state, scales = "free_y",switch = "y") + labs(title = "Incubations")

ggsave(paste("IC_incubations.png",sep=""), plot =IC_incubation_graph, path = path.expand(here("index","figures")),

       width =23, height = 50,units = "cm",dpi = 600)
...
mM_to_umol_p_g<- function(  Dens, 
 ...
 conc <- ((total_weight/Dens)*mM)/(sample_weight) 
